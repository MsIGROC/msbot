...
module.exports = {
    ...
    getHelpEmbed: function (guildId) {
        const repository = 'https://msbot.online';
        const credentials = `${repository}/documents/getting-started/fcm-credentials`;
        const pairServer = `${repository}/documents/getting-started/pair-and-connect-to-a-server`;
        const commands = `${repository}/documents/commands`;
